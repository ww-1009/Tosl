...
public class Code {
    ...
    private static com.rangi.nanodet.yzm.Code bmpCode;

    public static com.rangi.nanodet.yzm.Code getInstance() {
        if(bmpCode == null)
            bmpCode = new com.rangi.nanodet.yzm.Code();
        return bmpCode;
    }
