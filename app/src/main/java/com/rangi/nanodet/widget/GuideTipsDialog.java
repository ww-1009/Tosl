package com.rangi.nanodet.widget;
...
import com.rangi.nanodet.core.http.api.ApiService;
import com.rangi.nanodet.core.http.callback.NoTipCallBack;
import com.rangi.nanodet.core.http.entity.TipInfo;
import com.rangi.nanodet.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.rangi.nanodet.widget.key_is_ignore_tips_";
